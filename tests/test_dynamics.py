import pytest
import numpy as np
from marlin_twin.data_classes import VesselState, VesselDynamics, VesselType, VesselAction, EnvironmentCondition
...
def test_mmg_dynamics_step():
    dynamics = VesselDynamics(
        ...
        mass=1000000.0, moment_of_inertia=1e7,
        max_rpm=100.0, propeller_diameter=3.0
    )
